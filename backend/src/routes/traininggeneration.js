...
rotas.post('/reportGeneration', bloquer, validateToken, limiter(process.env.RATE_LIMIT_TIME_OF_REPORT, 'Máximo de solicitação para geração de PDF alcançada, aguarde ' + process.env.RATE_LIMIT_TIME_OF_REPORT + ' minuto(s) e tente novamente.', process.env.RATE_LIMIT_MAX_OF_REPORT), traininggeneration.reportGeneration)
